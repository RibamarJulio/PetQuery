...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="servico_banho.php" id="serv_banho" method="post">
                ...
                <select class="select-menu mb-5 form-control" name="nome" required>
                                    ...
                                    <?php
                                $query = "SELECT nome_pet , id_pet FROM PET WHERE FK_PET_CLI = '1'";
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <button type="submit" form="serv_banho" class="p-2" style="border: 1px solid #518CD7; background-color: #fff; border-radius: 5px; color: #0D51AA; width: 100px; font-weight: 600">Avançar<img class="ms-2" src="img/icons/seta-direita (2).png"></img></button>
            </div>
        </div>
    </div>
