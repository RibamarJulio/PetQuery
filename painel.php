...
<div class="container-fluid mt-5 mb-5" id="list_func" style="display: none">
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT id_funcionario, sobrenome, nome, cpf, ddd, telefone, email, data_nascimento, profissao, logadouro, numero, complemento, bairro, uf, cidade, cep, id_endereco_funcionario FROM funcionario INNER JOIN endereco_funcionario ON endereco_funcionario.fk_fun_end = funcionario.id_funcionario ORDER BY id_funcionario ASC";
                ...
                echo "<div class='col-lg-3'>";
                    echo "<div class='card func' style='border-radius: 20px; margin: 0 auto'>";
                        echo "<div class='card-body'>";
                            ...
                            echo "<a href='#' data-bs-toggle='modal' data-bs-target='#editfun".$row['id_funcionario']."' class='btn btn-success mb-2 mt-3'>Editar</a><a href='proc_excluir_func.php?name=".$row['id_funcionario']."' class='btn btn-danger ms-3 mb-2 mt-3'>Demitir</a>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
...
<div class="container-fluid mt-5 mb-5" id="list_cli" style="display: none">
    ...
    <?php
        ...
        <div class="row justify-content-center">
            ...
            $sql = "SELECT id_cliente, sobrenome, nome, cpf, ddd, telefone, email, data_nascimento, bairro, cep, complemento, logadouro, numero, uf, cidade, id_endereco_cliente FROM cliente INNER JOIN endereco_cliente ON cliente.id_cliente = endereco_cliente.fk_cli_end ORDER BY id_cliente ASC";

            $result = $mysqli->query($sql);

            while ($row = mysqli_fetch_assoc($result)){
                echo "<div class='col-lg-3'>";
                    echo "<div class='card cli' style='border-radius: 20px; margin: 0 auto'>";
                        echo "<div class='card-body'>";
                            echo "<h5 class='card-title mb-4 nome-func'>".$row['nome'] . " " . $row['sobrenome']."</h5>";
                            ...
                            echo "<p class='card-text' style='font-weight: 600'>Endereço: <span style='font-weight: 300' class='card-text'> ".$row['cep']. " - " .$row['logadouro']. ", " . $row['numero']. " - " . $row['bairro'] . ", " . $row['cidade'] . " - " . $row['uf'] . ", " . $row['complemento'] ."</span></p>";
                            echo "<p class='card-text' style='font-weight: 600'>Nascimento: <span style='font-weight: 300' class='card-text'>".$row['data_nascimento']."</span></p>";
                            echo "<a href='#' data-bs-toggle='modal' data-bs-target='#editcliente".$row['id_cliente']."' class='btn btn-success mb-2 mt-3'>Editar</a><a href='proc_excluir_cli.php?name=".$row['id_cliente']."' class='btn btn-danger ms-3 mb-2 mt-3'>Excluir</a>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
...
<div class="container-fluid mt-5 mb-5" id="list_ani" style="display: none">
    ...
    <?php
        ...
        <div class="row justify-content-center">
            ...
            while ($row = mysqli_fetch_assoc($result)){
                echo "<div class='col-lg-3'>";
                    echo "<div class='card ani' style='border-radius: 20px; margin: 0 auto'>";
                        echo "<div class='card-body'>";
                            ...
                            echo "<a href='#' data-bs-toggle='modal' data-bs-target='#editanimal".$row['id_pet']."' class='btn btn-success mb-2 mt-3'>Editar</a><a href='#' class='btn btn-danger ms-3 mb-2 mt-3'>Excluir</a>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
...
<div class="container-fluid mt-5 mb-5" id="list_agend" style="display: none">
    ...
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)){
            echo "<div class='col-lg-3'>";
                echo "<div class='card agend' style='border-radius: 20px; margin: 0 auto'>";
                    echo "<div class='card-body'>";
                        ...
                        echo "<a href='#' data-bs-toggle='modal' data-bs-target='#editaged".$row['id_aged_clst']."' class='btn btn-success mb-2 mt-3'>Editar</a><a href='#' class='btn btn-danger ms-3 mb-2 mt-3'>Excluir</a>";
                    echo "</div>";
                echo "</div>";
            echo "</div>";
