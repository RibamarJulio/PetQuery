                ...
                echo "<div class='col-lg-3'>";
                    echo "<div class='card cli' style='border-radius: 20px; margin: 0 auto'>";
                        echo "<div class='card-body'>";
                            ...
                            echo "<a href='#' data-bs-toggle='modal' data-bs-target='#editcliente".$row['id_cliente']."' class='btn btn-success mb-2 mt-3'>Editar</a><a href='#' class='btn btn-danger ms-3 mb-2 mt-3'>Excluir</a>";
                        echo "</div>";
                    echo "</div>";
                echo "</div>";
