...
<head>
    ...
    <link rel="stylesheet" href="css/perfil_cli_segu.css">
...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width:200px;" id="mySidebar">
        ...
        <label for="nome_cliente" class="mt-3 ms-3 mb-3" style="color: #000000; font-weight: 700; font-size: 20px">Olá,
        <?php echo $_SESSION['nome_perfil']?></label>
      ...
      <div class="w3-container">
        <p style="color: #808080; font-weight: 500;">Defina uma nova senha</p>
        <form action="proc_atualizar_sen.php" method="POST">
            <div class="row" style="max-width: 400px">
                <div class="col mb-2" id="colname">
                    <label class="placeholder" style="font-weight: 600">Nova senha</label>
                    <input type="password" class="form-control input" minlength="8" maxlength="20" name="senha">
                </div>
            </div><br>
            <div class="row" style="max-width: 400px">
                <div class="col mb-2" id="colname">
                    <label class="placeholder" style="font-weight: 600">Confirmar nova senha</label>
                    <input type="password" class="form-control input" minlength="8" maxlength="20" name="senhac">
                    <?php if(isset($_SESSION['msg'])){echo $_SESSION['msg'];unset($_SESSION['msg']);}?>
                </div>
            </div><br>
    
            <div>
                <button type="submit" class="btn btn-primary mb-3"id="criar">Salvar Senha</button>
            </div>
          </div>
        </form>
