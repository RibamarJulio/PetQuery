    ...
    <div class="container-fluid">
        ...
        <div class="container" id="form_cad" style="width: 70%">
            ...
            <div class="row justify-content-center text-center mt-4">
                <h6 style="font-weight: 600">Criar uma conta</h6>
            </div>
            <div class="row justify-content-center text-center mt-2 mb-5">
                <small class="form-text">Complete os campos com as suas informações</small>
                <?php if(isset($_SESSION['msg'])){echo $_SESSION['msg'];unset($_SESSION['msg']);}?>
            </div>
            <form method="POST" action="proc_cad_cli.php">
                        ...
                        <div class="mb-4">
                            <div class="row">
                                <div class="col-xl-4 mb-4">
                                    <input class="form-control" placeholder="Data de nascimento" type="text" onfocus="(this.type='date')" onkeydown="return false" max="<?php echo date('Y-m-d'); ?>" name="datanascimentocadastro" required>
                                </div>
